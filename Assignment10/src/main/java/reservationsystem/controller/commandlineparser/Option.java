...
public class Option {
   ...
   */
  public Option(Option option, String[] values) {
    this.name = option.name;
    this.description = option.description;
    this.required = option.required;
    this.hasSubArg = option.hasSubArg;
  ...
  /**
   * Has sub args boolean.
   *
   * @return hasSubArgs. boolean
   */
   ...
   * Gets arg splitter.
   *
   * @return argSplitter. arg splitter
   */
