/**
 * Represents an Address with their details--street number, street name, city name, state acronym,
 * zip code, country name
 */
public class Address {
  ...
  /**
   * creates a new address given the street number,street name, city name, state acronym, zip code
   * and country name*
   *
   ...
   */
  public Address(Integer streetNum, String streetName, String cityName, String stateAcronym,
      Integer zipCodeNum, String countryName) {
